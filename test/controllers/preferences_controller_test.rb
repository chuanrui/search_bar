...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { term: @preference.term, times: @preference.times, users_id: @preference.users_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { term: @preference.term, times: @preference.times, users_id: @preference.users_id } }
